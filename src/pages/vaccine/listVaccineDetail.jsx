                                        ...
                                        <table className="min-w-full bg-white rounded overflow-hidden">
                                            <thead className="bg-blue-100">
                                                <tr>
                                                    ...
                                                    <th className="px-4 py-2 text-left text-sm font-semibold text-blue-800">Liều lượng (ml)</th>
                                                </tr>
                                            </thead>
                                            <tbody className="divide-y divide-blue-100">
                                                {dosageGuidelines.map((item, index) => (
                                                    <tr key={index} className={index % 2 === 0 ? 'bg-blue-50' : 'bg-white'}>
                                                        ...
                                                        <td className="px-4 py-2 text-sm text-gray-700">{item.minDosage} - {item.maxDosage} ml</td>
                                                    </tr>
                                                ))}
                                            </tbody>
                                        </table>
                                        <p className="mt-4 text-sm text-gray-600 italic">
                                            Lưu ý: Liều lượng cụ thể sẽ được bác sĩ điều chỉnh tùy thuộc vào tình trạng sức khỏe của từng người
                                        </p>
                                    </div>
                                </div>
                            </div>

                            {/* Vaccine Details - Right Side */}
                                                ...
                                                <div className="flex items-start space-x-4">
                                                    {detail.imageUrl && (
                                                        <div className="w-32 h-32 flex-shrink-0">
                                                            <img 
                                                                src={detail.imageUrl} 
                                                                alt={detail.doseName || 'Vaccine image'}
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${detail.quantity > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
